...
with st.sidebar:
    ...
    st.markdown("**Dataset:** Preprocessed EV adoption data")
    st.markdown("**Model:** Trained forecasting model (Pickle format)")
    st.markdown("**Forecast Horizon:** 36 months (3 years)")
    st.markdown("---")
    st.markdown("💡 *Tip: You can compare up to 3 counties simultaneously!*")


st.markdown("""
    <hr style="margin-top: 50px; border: 1px solid #999;">
    <div style="text-align: center; font-size: 14px; color: #aaa;">
        🚗 Built with shell Green internship  by Devika | <a href="https://github.com/Devika2605" target="_blank">GitHub</a>
    </div>
""", unsafe_allow_html=True)

st.markdown(f"""
    <div style='text-align: center; font-size: 14px; color: #eeeeee; margin-bottom: 20px;'>
